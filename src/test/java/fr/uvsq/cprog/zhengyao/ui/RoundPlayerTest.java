...
class RoundPlayerTest {
        ...
        private GameDisplayer displayerMock;
        ...
        void setUp() {
                ...
                displayerMock = mock(GameDisplayer.class);
                ...
                when(joueur4.getMain()).thenReturn(new MainDeCartes(List.of(
                                new Carte.CarteBuilder().valeur(CarteValeur.TROIS).couleur(CarteCouleur.TREFLE)
                                                .build())));
                ...
                // Use displayerMock to initialize RoundPlayer
                RoundPlayer roundPlayer = new RoundPlayer(displayerMock);
                if (roundPlayer != null) {
                        System.out.println("RoundPlayer initialized successfully.");
                }
        }
}
